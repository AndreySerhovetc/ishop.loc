                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <div class="quantityty">
                                <input class="form-control" type="number" size="2" value="1" name="quantity" min="1" step="1">
                            </div>
                        ...
                        <div class="col-md-4 product-left p-left">
                            <div class="product-main simpleCart_shelfItem">
                                ...
                                <div class="product-bottom">
                                    ...
                                    <p>Explore Now</p>
                                    <h4><a class="item_add add-to-card-link" href="cart/add?id=<?=$item['id'];?>" data-id="<?=$item['id'];?>"><i></i></a>
                                        <span class="item_price"><?=$curr['symbol_left'];?>
                                            <?=$item['price'] * $curr['value'];?><?=$curr['symbol_right'];?></span>
                                        <?php if($item['old_price']): ?>
                                            <del><small><?=$curr['symbol_left'];?><?=$item['old_price'] * $curr['value'];?><?=$curr['symbol_right'];?></small></del>
                                        <?php endif; ?>
                                    </h4>
                                </div>
                                <?php if($item['old_price']): ?>
                                    <?php $sale = 100 - ($item['price'] * 100 / $item['old_price']);?>
